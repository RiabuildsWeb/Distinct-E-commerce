...
const Cart = () => {
  ...
  return (
    ...
    cartData.map(( item,index)=>{
      ...
      return(
       ...
       <div className='flex items-start gap-6'>   
        ...
        <img  onClick={()=>updateQuantity(item._id,item.size,0)} className=' w-4 mr-4 sm:5 cursor-pointer'src={binicon}alt="" />
        </div> 
      )
      })
   ...
   <div className='flex justify-end my-20'>
    ...
    <button  onClick={()=>navigate('/PlaceOrder')} className='bg-black text-white text-sm my-8 px-8 py-3 cursor-pointer'>PROCEED TO CHECK OUT</button>
    </div>
    </div>
